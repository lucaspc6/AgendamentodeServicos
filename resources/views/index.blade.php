        ...
        <div class="container"> 
            ...
            <div class="row">
                <div class="container mb-3 col-12" style="background-color: white; padding: 35px;">
                    ...
                    <p>
                        <form action="{{ route('criar_agendamentos') }}" method="post">
                            @csrf
                            <div class="mb-3  form-group">
                                <label for="name">Nome:</label>
                                <input type="text" id="nom" required name="nom" placeholder="Digite seu nome" class="form-control">
                            </div>

                            <div class="mb-3 form-group">
                                <label for="phone"> Telefone:</label>
                                <input type="text" id="tel" required name="tel" placeholder="(xx)xxxxx-xxxx" class="form-control">
                            </div>
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input type="date" class="form-control" required name="dt_ct" id="dt_ct">
                            </div>
