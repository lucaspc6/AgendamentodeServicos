					...
					<p>
						<form method="POST" action="index.blade.php">
							...
							<div class="form-group">
								...
								<input type="tel" class="form-control" required name="telefone" id="telefone" placeholder="(xx)xxxxx-xxxx">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" required name="data_contato" id="data_contato">
							</div>
							<div class="form-group">
